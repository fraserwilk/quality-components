	...
	*/
	...
	(function ($) {
	  ...
	  function updateCartBadgeFromForm() {
	    var cartForm = document.querySelector('.woocommerce-cart-form, .wp-block-woocommerce-cart');
	    if (!cartForm) {
	      return;
	    }
	    var count = Array.prototype.reduce.call(cartForm.querySelectorAll('.cart_item input.qty, ' + '.wc-block-components-quantity-selector__input'), function (total, input) {
	  ...
	  $(document.body).on('updated_wc_div wc_fragments_refreshed', updateCartBadgeFromForm);
	  $(document).on('input change', '.woocommerce-cart-form .cart_item input.qty, ' + '.wp-block-woocommerce-cart ' + '.wc-block-components-quantity-selector__input', updateCartBadgeFromForm);
	  $(document).on('click', '.wp-block-woocommerce-cart ' + '.wc-block-components-quantity-selector__button', function () {
